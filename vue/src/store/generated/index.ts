...
import NodemadicLoanNodemadicLoanLoan from './nodemadic/loan/nodemadic.loan.loan'
...
export default { 
  ...
  NodemadicLoanNodemadicLoanLoan: load(NodemadicLoanNodemadicLoanLoan, 'nodemadic.loan.loan'),
